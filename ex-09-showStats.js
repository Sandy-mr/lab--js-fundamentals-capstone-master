...
function showStats (number, stats) {
    ...
    obj.count_inputEqualTo = equal;
    obj.count_inputGreaterThan = greater;
    obj.count_inputLessThan = less;
    obj.inputArraySize = stats.length;
	return obj;
}
